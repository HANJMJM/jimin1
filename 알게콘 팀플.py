...
def love_psychology_test():
    ...
    print("1. 너가 뭐가 아쉬워 저런 사람을 만나냐, 너가 아깝다")
...
def attachment_test():
    questions = [
        ...
        "2.나는 버림을 받는 것에 대해 걱정하는 편이다.",
        "3.나는 다른 사람과 가까워지는 것이 매우 편안하다.",
        "4.상대방이 막 나와 친해지려고 할 때 꺼려하는 나를 발견한다.",
        "5.내가 다른 사람에게 관심을 가지는 만큼 그들이 나에게 관심을 가지지 않을까봐 걱정이다.",
        "6.나는 다른 사람이 나와 매우 가까워지려 할 때 불편하다.",
        "7.나는 나와 친한 사람을 잃을까봐 꽤 걱정이 된다.",
        "8.나는 다른 사람에게 마음을 여는 것이 편안하지 못하다.",
        "9.나는 종종 내가 상대방에게 호의를 보이는 만큼 상대방도 그렇게 해 주기를 바란다.",
        "10.나는 상대방과 가까워지기를 원하지만 나는 생각을 바꾸어 그만둔다.",
        "11.나는 상대방과 하나가 되길 원하기 때문에 사람들이 때때로 나에게서 멀어진다.",
        "12.나는 다른 사람이 나와 너무 가까워졌을 때 예민해진다.",
        "13.나는 혼자 남겨질까봐 걱정이다.",
        "14.나는 다른 사람에게 내 생각과 감정을 이야기하는 것이 편안하다.",
        "15.지나치게 친밀해지고자 하는 욕심 때문에 때로 사람들이 두려워하여 거리를 둔다.",
        "16.나는 상대방으로부터 사랑받고 있다는 것을 자주 확인받고 싶어한다.",
        "17.나는 다른 사람과 가까워지는 것이 비교적 쉽다.",
        "18.가끔 나는 다른 사람에게 더 많은 애정과 더 많은 헌신을 보여줄 것을 강요한다고 느낀다.",
        "19.나는 다른 사람에게 의지하기가 어렵다.",
        "20.나는 버림받는 것에 대해 때때로 걱정하지 않는다.",
        "21.나는 다른 사람과 너무 가까워지는 것을 좋아하지 않는다.",
        "22.만약 상대방이 나에게 관심을 보이지 않는다면 나는 화가난다.",
        "23.나는 상대방에게 모든 것을 이야기한다.",
        "24.상대방이 내가 원하는 만큼 가까워지는 것을 원치 않음을 안다.",
        "25.나는 대개 다른 사람에게 내 문제와 고민을 상의한다.",
        "26.내가 다른 사람과 교류가 없을 때 나는 다소 걱정스럽고 불안하다.",
        "27.다른 사람에게 의지하는 것이 편안하다.",
        "28.상대방이 내가 원하는 만큼 가까이에 있지 않을 때 실망하게 된다.",
        "29.나는 상대방에게 위로, 조언, 또는 도움을 청하지 못한다.",
        "30.내가 필요로 할 때 상대방이 거절한다면 실망하게 된다.",
        "31.상대방이 나에게 불만을 나타낼 때, 나 자신이 정말 형편없게 느껴진다.",
        "32.나는 위로와 확신을 비롯한 많은 일들을 상대방에게 의지한다.",
        "33.상대방이 나를 떠나서 많은 시간을 보냈을 때 나는 불쾌하다."
    ]
    
    responses = []
    for i, question in enumerate(questions):
        print(f"{i + 1}. {question}")
        print("1. 전혀 그렇지 않다, 2. 그렇지 않다, 3. 보통 정도이다, 4. 대체로 그렇다, 5. 매우 그렇다")
    ...
    print("\n결과:")
    print(f"회피 점수: {avoidance_score:.2f}")
    print(f"불안 점수: {anxiety_score:.2f}")
    print(f"당신의 애착 유형은 '{attachment_type}'입니다.\n")
    print("설명:")
    print(description)

def psychopath_test():
    questions = [
        "1.이익을 위해서라면 약속을 깨도 상관없다.",
        "2.자존감이 과도하게 높다.",
        "3.일상 생활에서 자극적인 요소가 필요하다.",
        "4.거짓말을 해도 아무렇지도 않다.",
        "5.사람을 다루는데 능숙해서 원하는 것을 쉽게 얻어낼 수 있다.",
        "6.죄책감을 잘 느끼지 않는다.",
        "7.다른 사람의 감정에 공감하기 어렵다.",
        "8.고통받는 동물을 봐도 아무렇지도 않다.",
        "9.남에게 빌붙어 살아도 상관없다.",
        "10.자제력이 부족한 편이다.",
        "11.쉽게 성적인 행동에 빠져든다.",
        "12.어릴 때 나쁜 짓을 자주 했다.",
        "13.현실적이고 장기적인 목표가 없다.",
        "14.충동적으로 행동할 때가 많다.",
        "15.책임감이 부족한 편이다.",
        "16.자신의 행동에 대한 책임감을 느끼기가 어렵다.",
        "17.기간이 짧은 많은 연애에 이끌린다.",
        "18.필요에 따라 사랑하는 사람을 배신할 수 있다.",
        "19.범죄를 저질러도 아무렇지도 않다.",
        "20.범죄적인 재능이 타고났다고 생각하거나 그것에 관심이 있다."
    ]
    
    total_score = 0
    for i, question in enumerate(questions):
        print(f"{i + 1}. {question}")
        print("1. 그렇지 않다, 2. 보통 정도이다, 3. 그렇다")
